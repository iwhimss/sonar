...
- [x] `ui/SonarValueField.qml`: yüzdeyi gösteren, tıklayınca düzenlenebilir alan.
...
- [x] Yanında sıfırlama düğmesi → 1.0. Değer 1.0'ken pasif.
- [x] Kanal şeridi (2 fader), master şeridi (2 fader), giriş şeritleri — tek bileşen.
- [x] Çift tıkla sıfırlama (`SonarFader.qml:114`) kalıyor; düğme onu görünür kılıyor.
- [x] 148 px'lik şeritte taşmasın.
